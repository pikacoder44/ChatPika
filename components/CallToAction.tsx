...
const CTA = () => {
  return (
    <div className="relative overflow-hidden bg-amber-300 p-8 m-8 rounded-2xl shadow-lg flex flex-row items-center justify-between">
      ...
      <Link href={"/chat"}>
        <Button
          variant="default"
          size="lg"
          className="px-8 py-4 text-lg font-semibold rounded-xl mt-6 transition-colors duration-200 ease-in-out 
                   shadow-lg hover:cursor-pointer hover:text-white hover:bg-zinc-800"
        >
          Try ChatPik{" "}
          <svg
